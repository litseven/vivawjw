...
<ul class="nav nav-tabs">
    ...
    <li<?php  if($op == 'hot_key_list') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage',array('op'=>'hot_key_list'))?>">关键字列表</a></li>
    <li<?php  if($op == 'hot_key') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage',array('op'=>'hot_key'))?>">热门搜索关键字</a></li>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td id="update_<?php  echo $item['id'];?>" style="text-align: center">
                            ...
                            <span class="btn btn-sm btn-success status-toggle" id="<?php  echo $item['id'];?>" data-toggle="0" title="点击修改">显示</span>
                            <?php  } else { ?>
                            <span class="btn btn-sm btn-warning status-toggle" id="<?php  echo $item['id'];?>" data-toggle="1" title="点击修改">隐藏</span>
                            <?php  } ?>
        ...
        <div class="panel panel-default">
            <div class="panel-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php  if(is_array($keylist)) { foreach($keylist as $item) { ?>
                    <tr>
                        <td style="vertical-align:middle;text-align: center"><?php  echo $item['id'];?></td>
                        <td style="vertical-align:middle;text-align: center"><?php  echo $item['hotkey'];?></td>
                        <td id="update_<?php  echo $item['id'];?>" style="text-align: center">
                            <?php  if($item['status'] == 1) { ?>
                            <span class="btn btn-sm btn-success status-toggle" id="<?php  echo $item['id'];?>" data-toggle="0" title="点击修改">显示</span>
                            <?php  } else { ?>
