...
<ul class="order-nav order-nav-tabs" style="background:none;float: left;margin-left: 0px;padding-left: 0px;border-bottom:1px #c5d0dc solid;">
	<li<?php  if($status == 2) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage', array('status' => 2))?>">待确认</a></li>
	<li<?php  if($status == 1) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage', array('status' => 1))?>">已确认</a></li>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr style="text-align: center">
							...
							<td><?php  echo $item['recordnum'];?></td>
							<td><?php  echo $item['accaddr'];?></td>
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-9 col-md-9">
					<p class="form-control-static"><?php  echo $info['recordnum'];?></p>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-9 col-md-9">
					<p class="form-control-static"><?php  echo $info['accaddr'];?></p>
				</div>
			</div>
		</div>
	</div>
    <div class="panel panel-default">
				...
				<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-9 col-xs-9 col-md-9">
								<p class="form-control-static"><?php  echo $info['accname'];?></p>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-12 col-sm-3 col-md-2 control-label">车牌号:</label>
							<div class="col-sm-9 col-xs-9 col-md-9">
								<p class="form-control-static"><?php  echo $info['accnum'];?></p>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-12 col-sm-3 col-md-2 control-label">对方姓名:</label>
							<div class="col-sm-9 col-xs-9 col-md-9">
								<p class="form-control-static"><?php  echo $info['accothername'];?></p>
							</div>
						</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">对方车牌:</label>
						<div class="col-sm-9 col-xs-9 col-md-9">
							<p class="form-control-static"><?php  echo $info['accothernum'];?></p>
						</div>
					</div><div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">对方电话:</label>
						<div class="col-sm-9 col-xs-9 col-md-9">
							<p class="form-control-static"><?php  echo $info['accotherphone'];?></p>
						</div>
					</div>
                	</div>
                    </div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
                        ...
                        <?php  } else { ?>
						<div class="col-sm-9 col-xs-9 col-md-9">
							<p class="form-control-static"><?php  if($info['status']==1) { ?>受理<?php  } else { ?>驳回<?php  } ?></p>
						</div>
						<?php  } ?>
					</div>
				</div>
