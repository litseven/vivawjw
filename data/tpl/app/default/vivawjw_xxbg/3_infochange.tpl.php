    ...
    <div class="content_box">
        ...
        <div class="ill_query">
            ...
            <div class="query_box" >
                <div class="car_style">
                    <div>驾驶证号</div>
                    <input type="text" name="drivernum" id="car_number1" placeholder="请输入驾驶证号" onFocus="this.placeholder=''" onBlur="this.placeholder='请输入驾驶证号'">
                </div>
                <div class="car_style">
                    <div>证芯编号<br><a class="where">(在哪里)</a></div>
                    <input type="text" name="driverpapers" placeholder="请输入证芯编号后六位或档案编号后六位" id="car_fa1" onFocus="this.placeholder=''" onBlur="this.placeholder='请输入证芯编号后六位或档案编号后六位'">
                </div>
                <a id="query1">下一步</a>
            </div>
            <?php  } ?>
            ...
            <div class="query_box">
                ...
                <div class="car_style">
                    <div>证件号码</div>
                    <input type="text" name="carpapers" placeholder="请输入身份证后六位或机构代码证前六位" id="car_fa" onFocus="this.placeholder=''" onBlur="this.placeholder='请输入身份证后六位或机构代码证前六位'">
                </div>
                <a id="query">下一步</a>
            </div>
            <?php  } ?>
    ...
    $(function(){
        ...
        $('#query1').click(function(){
            ...
            $.post("<?php  echo $this->createMobileUrl('drivermanage')?>",{'drivernum':drivernum,'driverpapers':driverpapers},function(data){
                if (data == 200){
                    window.location.href = "<?php  echo $this->createMobileUrl('infochange',array('op' => 'subdata','block'=>'driver'))?>";
                }
            });
            process = true;
        ...
        $('#query').click(function(){
            ...
            var carpapers = $("[name = 'carpapers']").val();
            reg=/^苏B[0-9A-Z]{5}$/;
            if (!reg.test(carnum)){
            ...
            if(carpapers.length != 6){
                alert('证件号码输入有误！');return false;
            }
            $("#loading-fs").show();
            $.post("<?php  echo $this->createMobileUrl('carmanage')?>",{'cartype':cartype,'carnum':carnum,'carpapers':carpapers},function(data){
                if (data == 200){
                    window.location.href = "<?php  echo $this->createMobileUrl('infochange',array('op' => 'subdata','block'=>'car'))?>";
                }
            });
            process = true;
        });
