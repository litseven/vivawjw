...
<head>
    ...
    <link href="<?php echo S_URL;?>tongzhou/css/index.css" rel="stylesheet">
    <script src="<?php echo S_URL;?>tongzhou/js//jquery-3.0.0.js"></script>
    <script src="<?php echo S_URL;?>tongzhou/js//index.js"></script>
    <title>警务监督</title>
</head>
<body >
<!--首页-->
...
<div class="page1">
    <div class="bannerDiv">
        <img src="<?php echo S_URL;?>tongzhou/img/banner.png">
    </div>
    ...
    <form method="post" action="#">
        <div class="content6Div">
            ...
            <div class="contentList">
                <?php  if(is_array($dataList)) { foreach($dataList as $item) { ?>
                <h3><?php  echo $item['id'];?>、<?php  echo $item['title'];?></h3>
                <!--下拉-->
                <?php  if($item['type'] == 'select') { ?>
                <select class="citySelect" name="question_<?php  echo $item['id'];?>">
                    <?php  if(is_array($item['key'])) { foreach($item['key'] as $k => $it) { ?>
                    <option value="<?php  echo $k+1?>"><?php  echo $it;?></option>
                    <?php  } } ?>
                </select>
                <?php  } ?>
                <!--单选-->
                ...
                <?php  if(is_array($item['key'])) { foreach($item['key'] as $k => $it) { ?>
                <label>
                    <input name="question_<?php  echo $item['id'];?>" type="radio" value="<?php  echo $k+1?>" />
                    <label class="contentItem"><?php  echo $it;?></label>
                </label>
                <?php  } } ?>
                <?php  } ?>
                <!--多选-->
                <?php  if($item['type'] == 'checked') { ?>
                <?php  if(is_array($item['key'])) { foreach($item['key'] as $k => $it) { ?>
                <label>
                    <input name="question_<?php  echo $item['id'];?>[]" type="checkbox" value="<?php  echo $k+1?>"/>
                    <label class="contentItem"><?php  echo $it;?></label>
                </label>
                <?php  } } ?>
                <?php  } ?>
