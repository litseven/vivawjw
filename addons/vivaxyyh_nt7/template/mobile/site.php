...
define('S_URL', 'http://' . $_SERVER['HTTP_HOST'] . '/addons/viva_xyyh/resource/');

class Viva_xyyhModuleSite extends WeModuleSite {
	...
	public function createImg($bg_path, $head_path, $level_path, $qrcode_url, $days, $name, $content) {
		...
		$qrcode_path = 'http://pan.baidu.com/share/qrcode?w=137&h=137&url=' . $shorturl;
